CityInfo=[
          ...
          {value: 5, label: '内蒙古自治区', children: [
              ...
              {value: 35, label: '锡林郭勒盟市', children: [
          ...
          {value: 31, label: '新疆自治区', children: [
              ...
              {value: 330, label: '博尔塔拉自治州', children: [
                  {value: 2794, label: '博乐市'},
                  {value: 2795, label: '精河县'},
                  {value: 2796, label: '温泉县'}
              ]},
              {value: 331, label: '巴音郭楞自治州', children: [
              ...
              {value: 333, label: '克孜勒苏柯尔克孜自治州', children: [
              ...
              {value: 336, label: '伊犁哈萨克自治州', children: [
          ...
          {value: 34, label: '台湾省', children: [
            {value: 343, label: '台北市', children: [
                {value: 2863, label: '内湖区'},
                {value: 2864, label: '南港区'},
                {value: 2865, label: '中正区'},
                {value: 2866, label: '万华区'},
                {value: 2867, label: '大同区'},
                {value: 2868, label: '中山区'},
                {value: 2869, label: '松山区'},
                {value: 2870, label: '大安区'},
                {value: 2871, label: '信义区'},
                {value: 2872, label: '文山区'},
                {value: 2873, label: '士林区'},
                {value: 2874, label: '北投区'}
            ]},
            {value: 344, label: '新北市', children: [
                {value: 2875, label: '板桥区'},
                {value: 2876, label: '汐止区'},
                {value: 2877, label: '新店区'},
                {value: 2878, label: '永和区'},
                {value: 2879, label: '中和区'},
                {value: 2880, label: '土城区'},
                {value: 2881, label: '树林区'},
                {value: 2882, label: '三重区'},
                {value: 2883, label: '新庄区'},
                {value: 2884, label: '芦洲区'},
                {value: 2885, label: '瑞芳区'},
                {value: 2886, label: '三峡区'},
                {value: 2887, label: '莺歌区'},
                {value: 2888, label: '淡水区'},
                {value: 2889, label: '万里区'},
                {value: 2890, label: '金山区'},
                {value: 2891, label: '深坑区'},
                {value: 2892, label: '石碇区'},
                {value: 2893, label: '平溪区'},
                {value: 2894, label: '双溪区'},
                {value: 2895, label: '贡寮区'},
                {value: 2896, label: '坪林区'},
                {value: 2897, label: '乌来区'},
                {value: 2898, label: '泰山区'},
                {value: 2899, label: '林口区'},
                {value: 2900, label: '五股区'},
                {value: 2901, label: '八里区'},
                {value: 2902, label: '三芝区'},
                {value: 2903, label: '石门区'}
            ]},
            {value: 345, label: '桃园市', children: [
                {value: 2904, label: '桃园区'},
                {value: 2905, label: '中坜区'},
                {value: 2906, label: '平镇区'},
                {value: 2907, label: '八德区'},
                {value: 2908, label: '杨梅区'},
                {value: 2909, label: '芦竹区'},
                {value: 2910, label: '大溪区'},
                {value: 2911, label: '龙潭区'},
                {value: 2912, label: '龟山区'},
                {value: 2913, label: '大园区'},
                {value: 2914, label: '观音区'},
                {value: 2915, label: '新屋区'},
                {value: 2916, label: '复兴区'},
            ]},
            {value: 346, label: '台中市', children: [
                {value: 2917, label: '中区'},
                {value: 2918, label: '东区'},
                {value: 2919, label: '南区'},
                {value: 2920, label: '西区'},
                {value: 2921, label: '北区'},
                {value: 2922, label: '北屯区'},
                {value: 2923, label: '西屯区'},
                {value: 2924, label: '南屯区'},
                {value: 2925, label: '太平区'},
                {value: 2926, label: '大里区'},
                {value: 2927, label: '雾峰区'},
                {value: 2928, label: '乌日区'},
                {value: 2929, label: '丰原区'},
                {value: 2930, label: '后里区'},
                {value: 2931, label: '潭子区'},
                {value: 2932, label: '大雅区'},
                {value: 2933, label: '神冈区'},
                {value: 2934, label: '石冈区'},
                {value: 2935, label: '东势区'},
                {value: 2936, label: '新社区'},
                {value: 2937, label: '和平区'},
                {value: 2938, label: '大肚区'},
                {value: 2939, label: '沙鹿区'},
                {value: 2940, label: '龙井区'},
                {value: 2941, label: '梧栖区'},
                {value: 2942, label: '清水区'},
                {value: 2943, label: '大甲区'},
                {value: 2944, label: '外埔区'},
                {value: 2945, label: '大安区'}
            ]},
            {value: 347, label: '台南市', children: [
                {value: 2946, label: '中西区'},
                {value: 2947, label: '东区'},
                {value: 2948, label: '南区'},
                {value: 2949, label: '北区'},
                {value: 2950, label: '安平区'},
                {value: 2951, label: '安南区'},
                {value: 2952, label: '永康区'},
                {value: 2953, label: '归仁区'},
                {value: 2954, label: '新化区'},
                {value: 2955, label: '左镇区'},
                {value: 2956, label: '玉井区'},
                {value: 2957, label: '楠西区'},
                {value: 2958, label: '南化区'},
                {value: 2959, label: '仁德区'},
                {value: 2960, label: '关庙区'},
                {value: 2961, label: '龙崎区'},
                {value: 2962, label: '官田区'},
                {value: 2963, label: '麻豆区'},
                {value: 2964, label: '佳里区'},
                {value: 2965, label: '西港区'},
                {value: 2966, label: '七股区'},
                {value: 2967, label: '将军区'},
                {value: 2968, label: '学甲区'},
                {value: 2969, label: '北门区'},
                {value: 2970, label: '新营区'},
                {value: 2971, label: '后壁区'},
                {value: 2972, label: '白河区'},
                {value: 2973, label: '东山区'},
                {value: 2974, label: '六甲区'},
                {value: 2975, label: '下营区'},
                {value: 2976, label: '柳营区'},
                {value: 2977, label: '盐水区'},
                {value: 2978, label: '善化区'},
                {value: 2979, label: '大内区'},
                {value: 2980, label: '山上区'},
                {value: 2981, label: '新市区'},
                {value: 2982, label: '安定区'}
            ]},
            {value: 348, label: '高雄市', children: [
                {value: 2983, label: '旧高雄地区'},
                {value: 2984, label: '凤山地区'},
                {value: 2985, label: '冈山地区'},
                {value: 2986, label: '旗山地区'},
                // 安徽省铜陵市枞阳县是2987
            ]},
          ]}
         ]
                ...
                for(var k=0;k<box.othersClum[j].chrildren.length;k++){
                  ...
                  for(var z=0;z<data.works.length;z++){
                    ...
                    for(var i=0;i<data.works[z].dataList.length;i++){
                      ...
                      if(dayD.dataList[i].yearMonthDate==iDate){
                        box.othersClum[j].chrildren[k].value=dayD.dataList[i].fdWorkload;
                        box.othersClum[j].chrildren[k].id=dayD.dataList[i].fdWorkid;
                        box.othersClum[j].chrildren[k].fdScheduleid=dayD.fdScheduleid;
                      }
                      if(new Date(iDate).getTime()>=new Date(dayD.dataList[i].yearMonthDate).getTime() && new Date(iDate).getTime()<new Date(dayD.startDate).getTime()){
                      ...
                      }else if(new Date(iDate).getTime()>new Date(dayD.endDate).getTime() &&new Date(iDate).getTime()<=new Date(dayD.dataList[i].yearMonthDate).getTime()){
          ...
          /*  var data=[
              ...
              {name:"计划工期三",status:true,type:"plan",
                times:[
                  ...
                  {startDate:"2018-08-01",endDate:"2018-09-19"}
                  ]
              },
              { name:"道路清表",type:"work",fdRoadType:"1",
                works:[
                  {startDate:"2018-07-20",
                    endDate:"2018-07-25",
                    fdScheduleid:"2",
                    dataList:[
                        {id:"",value:"1",date:"2018-07-17",colorNum:"",showText:""},
                        {id:"",value:"1",date:"2018-07-19",colorNum:"",showText:""},
                        {id:"",value:"1",date:"2018-07-20",colorNum:"",showText:""},
                        {id:"",value:"1",date:"2018-07-26",colorNum:"",showText:""},
                        {id:"",value:"1",date:"2018-07-28",colorNum:"",showText:""}
                    ]
                  },
                  {startDate:"2018-08-01",
                    ...
                    fdScheduleid:"3",
                    dataList:[
                      {id:"",value:"1",date:"2018-07-30",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-08-01",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-08-02",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-08-20",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-08-21",colorNum:"",showText:""}
                    ]
                  }
                ]
              },
              { name:"道路放线",type:"work",fdRoadType:"",
                works:[
                  {startDate:"2018-07-20",
                    endDate:"2018-07-25",
                    fdScheduleid:"",
                    dataList:[
                      ...
                      {id:"",value:"1",date:"2018-07-20",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-07-26",colorNum:"",showText:""},
                      {id:"",value:"1",date:"2018-07-27",colorNum:"",showText:""}
                    ]
                  },
                  {startDate:"2018-08-01",
                    endDate:"2018-08-19",
              ...
              { name:"道路施工",type:"work",fdRoadType:"",
                works:[
                  {startDate:"2018-07-20",
                    endDate:"2018-07-25",
                    fdScheduleid:"",
              ...
              { name:"道路平整",type:"work",fdRoadType:"",
                works:[
                  {startDate:"2018-07-20",
                    endDate:"2018-07-25",
                    fdScheduleid:"",
            ...
            var _this=this;
            this.$http.post('/engineer/getGanttChart', {fdStageName:this.$parent.$parent.$parent.activeName,fdProid:this.$parent.$parent.$parent.popData.fdProid})
              .then(res => {
